...
SECRET_KEY = 'django-insecure-j^q#ul^lvpi+50&7fur6s$or(ug5=q%)^s(z^_v5c%uv()%0-j'
...
AUTH_USER_MODEL = 'FanBoard_MMORPG.User'
...
ACCOUNT_FORMS = {"signup": "FanBoard_MMORPG.forms.CommonSignupForm"}
